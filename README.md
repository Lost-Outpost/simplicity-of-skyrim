...
Simplicity of Skyrim is a minimalist modlist containing essential fixes and tools along with a lightweight visual overhaul. Some optional gameplay and content addons are included that can be customized to your liking. The list is intended for players to be able to [import their vanilla save](https://github.com/Lost-Outpost/simplicity-of-skyrim/blob/main/EXISTINGSAVE.md) without having to start all the way over again. Finally, a cure for restartitis! Simplicity of Skyrim should in theory never need any save-breaking changes due to its minimally invasive nature.

## List Contents

You can browse the full list contents [here](https://loadorderlibrary.com/lists/simplicity-of-skyrim) if you want to know exactly what you're getting.
...
1. Create a folder for the List at the root of your drive (like the Wabbajack folder) called "Simplicity of Skyrim"
...
3. Download the latest release of `Simplicity of Skyrim` from the Wabbajack Browse Modlists page
...
Make sure the dropdown box on the right is set to `Simplicity of Skyrim` and press the Run button.
...
For issues that aren't yet [known](HELP.md), you can provide details in the [Simplicity of Skyrim Github](https://github.com/Lost-Outpost/simplicity-of-skyrim/issues). Please provide as much info as you can (screenshots are great).

Finally, free feel to hop on the Simplicity of Skyrim Discord support channel to have discussions with our knowledgeable community members. Support is offered in [The Lost Outpost](https://discord.gg/WF66mMu).

# Simplicity of Skyrim Team
+ Guitarninja :)
