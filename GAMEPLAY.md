...
> :ledger: **IMPORTANT NOTE: This gameplay guide reflects the Simplicity of Skyrim 1.0.x version. Guides for previous versions may be found by clicking the History button in the upper left corner of this page.**

## Overview

On your journey through the Simplicity of Skyrim, you will find a performance-friendly yet visually stunning environment, with thoughtfully curated, integrated, and balanced additions. As you explore this expanded yet familiar Skyrim world, you will discover plenty of high-quality and fun experiences.

This guide highlights major mods included in Simplicity of Skyrim in the following categories:
...
- :ledger: indicates Simplicity of Skyrim configuration notes
- :video_game: indicates Simplicity of Skyrim play testing observations
